...
--[[
	...
	Cada "tick" el sistema:
	  ...
	  4. Replica los valores al cliente por RemoteEvent para dibujar la UI.
...
Players.PlayerAdded:Connect(function(player)
	...
	-- Al reaparecer, restauramos sed y energía al máximo
...
task.spawn(function()
	while true do
		...
		for player, stats in statsPorJugador do
